  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-label="Idioma"
        className="inline-flex items-center gap-1.5 rounded-[9px] border border-[rgba(255,255,255,.1)] bg-surface px-3 py-[9px] text-xs font-semibold text-secondary transition-colors hover:text-primary"
      >
      ...
      {aberto && (
        <div
          role="listbox"
          className="absolute right-0 z-40 mt-1.5 w-44 overflow-hidden rounded-[10px] border border-[rgba(255,255,255,.12)] bg-elevated py-1 shadow-xl"
