...
/**
 * Detalhe do orçamento na LINGUAGEM DA FICHA (redesign 28/08/2026): o popup
 * do show na agenda era a única tela de detalhe agradável — esta página agora
 * é "o popup em escala de página": um card único centrado, cabeçalho com a
 * cor do artista e blocos com ícone (FichaUI). Toda ação/permissão preservada.
 */
    ...
    <div className="max-w-[720px] mx-auto w-full p-6 lg:p-8">
      ...
      <div className="card">
            ...
            <>
              ...
              {(cs?.nome || cid) && (
                <span className="text-secondary font-normal">
                  {" "}· {cs?.nome ?? (cid ? `${cid.nome}, ${cid.estado}` : "")}
                </span>
              )}
            </>
          }
        ...
        {orc.status !== "recusado" && camposFaltantes.length > 0 && (
          <div
            className="mb-5 flex items-start gap-3 rounded-md border p-3"
        ...
        <div className="flex flex-col gap-5">
          ...
          {/* ===== PAGAMENTO — cachê em destaque, como no popup ===== */}
          ...
          {/* ===== INFORMAÇÕES EXTRAS — editáveis inline ===== */}
          ...
          {/* ===== PRÉ-VISUALIZAÇÃO DO WHATSAPP — colapsada por padrão ===== */}
