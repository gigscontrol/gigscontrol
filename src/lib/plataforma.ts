...
// ============================================================
// LOGS / ATIVIDADE RECENTE DA PLATAFORMA
// ============================================================
...
export const MOCK_LOGS: LogPlataforma[] = [
  { id: "l-01", tipo: "pagamento", descricao: "Pagamento confirmado — plano Agência Plus", workspace: "TWO DASH", data: "2026-05-21T13:45:00Z" },
  { id: "l-02", tipo: "login", descricao: "Novo acesso de Juliana Prado", workspace: "Prime Talent", data: "2026-05-21T12:50:00Z" },
  { id: "l-03", tipo: "assinatura", descricao: "Nova assinatura criada (trial)", workspace: "Nightfall Agency", data: "2026-05-21T10:25:00Z" },
  { id: "l-04", tipo: "usuario", descricao: "Usuário Beatriz Lima foi bloqueado", workspace: "Beat Collective", data: "2026-05-20T18:30:00Z" },
  { id: "l-05", tipo: "plano", descricao: "Upgrade de plano: Equipe → Agência", workspace: "Lunar Booking", data: "2026-05-20T15:10:00Z" },
  { id: "l-06", tipo: "pagamento", descricao: "Falha no pagamento — cobrança reagendada", workspace: "Groove Management", data: "2026-05-20T09:00:00Z" },
  { id: "l-07", tipo: "sistema", descricao: "Backup automático concluído", data: "2026-05-20T03:00:00Z" },
  { id: "l-08", tipo: "login", descricao: "Novo acesso de Marcos Vieira", workspace: "DJ Marcos Vieira", data: "2026-05-21T07:15:00Z" },
  { id: "l-09", tipo: "assinatura", descricao: "Assinatura cancelada", workspace: "MC Studio Booking", data: "2026-05-19T20:00:00Z" },
  { id: "l-10", tipo: "usuario", descricao: "Novo usuário adicionado (produtor)", workspace: "Lunar Booking", data: "2026-05-19T11:30:00Z" },
];

// ============================================================
// MÉTRICAS HISTÓRICAS — crescimento mensal (para gráficos)
// ============================================================

export type PontoCrescimento = {
  mes: string; // "Jan", "Fev"...
  receita: number; // R$ MRR no mês
  clientes: number;
};

export const MOCK_CRESCIMENTO: PontoCrescimento[] = [
  { mes: "Dez", receita: 2100, clientes: 2 },
  { mes: "Jan", receita: 2950, clientes: 3 },
  { mes: "Fev", receita: 3650, clientes: 4 },
  { mes: "Mar", receita: 4800, clientes: 5 },
  { mes: "Abr", receita: 5400, clientes: 6 },
  { mes: "Mai", receita: 6750, clientes: 8 },
];

/** Indicadores de SaaS — alguns mockados pois dependem de histórico real */
export const METRICAS_SAAS = {
  /** Churn mensal (%) */
  churnMensal: 4.2,
  /** Receita acumulada total (R$) */
  receitaTotal: 48750,
  /** Total de shows cadastrados na plataforma (todos os workspaces) */
  showsCadastrados: 1284,
  /** Total de contratos/orçamentos gerados */
  contratosGerados: 892,
  /** Usuários ativos nos últimos 30 dias */
  usuariosAtivos30d: 47,
  /** LTV médio estimado (R$) */
  ltv: 9800,
  /** CAC médio estimado (R$) */
  cac: 1450,
};
