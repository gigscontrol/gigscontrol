...
const COLS =
  "id, workspace_id, nome, email, username, papel, is_super_admin, artista_id, escopo, funcoes, status, deletado_em, senha_padrao, senha_padrao_valor, pais, documento_tipo, documento, endereco, telefone";
