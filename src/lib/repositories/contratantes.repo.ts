...
const COLS =
  "id, workspace_id, nome, documento, documentos, pais, email, telefone, endereco, cidade_id, observacoes, criado_por, criado_em, lat, lng, geo_precision, bloqueado, bloqueado_motivo, bloqueado_por, bloqueado_em";
