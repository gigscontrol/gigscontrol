...
/**
 * Fallback estático dos artistas — usado APENAS quando a sessão ainda não
 ...
 */
export const ARTISTAS_FALLBACK: Artista[] = [
...
export const DEFAULT_SELECTED_ARTISTA_IDS: string[] = ARTISTAS_FALLBACK.map((d) => d.id);
